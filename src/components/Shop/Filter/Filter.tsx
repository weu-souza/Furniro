...
const Filter = ({
  ...
  return (
    <div
      ...
      className="bg-cor-F9F1E7 md:h-20 flex py-2 gap-4 flex-col md:flex-row justify-around"
    >
      ...
      <form className="flex gap-5 items-center justify-center my-auto">
        <label
          htmlFor="show"
          className="font-Poppins font-normal text-xl text-black"
        >
          show
        </label>
        <select
        ...
        <select
          ...
          value={category}
          className="font-Poppins font-normal text-xl text-cor-9F9F9F my-auto outline-none  p-2"
        >
