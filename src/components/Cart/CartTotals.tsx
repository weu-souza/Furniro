...
const CartTotals = ({total}:cartType) => {
...
const navigate = useNavigate()
  ...
  return (
    <div className="  ">
      ...
      <button className="font-Poppins font-normal text-xl text-black border border-black rounded-xl py-3 px-12 mx-auto" onClick={redirectCheckout}>Check Out</button>
    </div>
    </div>
  )
}
