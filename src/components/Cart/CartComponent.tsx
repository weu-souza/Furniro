...
const CartComponent = ({cart,deleteCart,quantidade,onIncrease,onDecrease}:cartType) => {
  return (
    <div className="grid  grid-cols-6 w-ful gap-5  py-4  items-center ">
        ...
        <p className="font-Poppins font-normal text-base text-cor-9F9F9F col-span-1">Rp. {cart.normalPrice}</p>
        <div className="flex border border-cor-9F9F9F px-1 w-[120px] py-1 h-12 rounded-xl gap-4 items-center col-span-1">
          <button
